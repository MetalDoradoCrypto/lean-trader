...
class BBBounce(QCAlgorithm):
    """Price at lower BB + RSI<35 indicates bounce"""
    ...
    def ShouldEntry(self, data):
        ...
        if "BB_Bounce" == "RSI_Momentum": return rsi_ok and price_ok
        elif "BB_Bounce" == "MACD_Cross": return macd_ok
        elif "BB_Bounce" == "BB_Bounce":
            bb_ok = self.bb.IsReady and p < self.bb.LowerBand.Current.Value
            return bb_ok and rsi_ok
        elif "BB_Bounce" == "Volume_Surge": return vol_ok and p > bar.Open
        elif "BB_Bounce" == "EMA_Cross":
    ...
    def ShouldExit(self, data):
        ...
        if loss > 2.5: return True
        gain = (curr - entry) / entry * 100
        if gain > 5.0: return True
