...
class RSIMomentum(QCAlgorithm):
    """RSI<30 + price>SMA200 indicates bounce"""
    ...
    def ShouldEntry(self, data):
        ...
        if "RSI_Momentum" == "RSI_Momentum": return rsi_ok and price_ok
        elif "RSI_Momentum" == "MACD_Cross": return macd_ok
        elif "RSI_Momentum" == "BB_Bounce":
            bb_ok = self.bb.IsReady and p < self.bb.LowerBand.Current.Value
            return bb_ok and rsi_ok
        elif "RSI_Momentum" == "Volume_Surge": return vol_ok and p > bar.Open
        elif "RSI_Momentum" == "EMA_Cross":
    ...
    def ShouldExit(self, data):
        ...
        if loss > 3.0: return True
        gain = (curr - entry) / entry * 100
        if gain > 6.0: return True
