...
class EMACross(QCAlgorithm):
    ...
    def ShouldEntry(self, data):
        ...
        if "EMA_Cross" == "RSI_Momentum": return rsi_ok and price_ok
        elif "EMA_Cross" == "MACD_Cross": return macd_ok
        elif "EMA_Cross" == "BB_Bounce":
            bb_ok = self.bb.IsReady and p < self.bb.LowerBand.Current.Value
            return bb_ok and rsi_ok
        elif "EMA_Cross" == "Volume_Surge": return vol_ok and p > bar.Open
        elif "EMA_Cross" == "EMA_Cross":
