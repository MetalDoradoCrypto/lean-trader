...
class VolumeSurge(QCAlgorithm):
    """Volume>2xSMA + price up indicates momentum"""
    ...
    def ShouldEntry(self, data):
        ...
        if "Volume_Surge" == "RSI_Momentum": return rsi_ok and price_ok
        elif "Volume_Surge" == "MACD_Cross": return macd_ok
        elif "Volume_Surge" == "BB_Bounce":
            bb_ok = self.bb.IsReady and p < self.bb.LowerBand.Current.Value
            return bb_ok and rsi_ok
        elif "Volume_Surge" == "Volume_Surge": return vol_ok and p > bar.Open
        elif "Volume_Surge" == "EMA_Cross":
